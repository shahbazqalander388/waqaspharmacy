...
const PrescriptionBanner = () => {
  return (
    <section id="prescription" className="py-10 sm:py-14 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-20">
      <div className="relative rounded-3xl overflow-hidden bg-white text-[#0F172A] p-6 sm:p-10 lg:p-12 shadow-lg border border-slate-200">
        
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          
          {/* Left Text & Steps */}
          <div className="lg:col-span-7 space-y-5">
            <div className="inline-flex items-center gap-2 bg-red-50 px-3.5 py-1 rounded-full text-xs font-black text-[#B91C1C] border border-red-200">
              <Camera className="w-3.5 h-3.5 text-[#B91C1C]" />
              <span>PRESCRIPTION HOME DELIVERY</span>
            </div>

            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-[#0F172A] leading-tight">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
              <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200">
                <div className="w-7 h-7 rounded-lg bg-[#B91C1C] text-white font-black text-xs flex items-center justify-center mb-2 shadow-2xs">
                  1
                </div>
            ...
            <div className="pt-2">
              <a
                ...
                className="inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#20bd5a] text-white font-black text-sm sm:text-base px-6 py-4 rounded-2xl shadow-lg shadow-green-950/15 hover:shadow-green-950/25 hover:scale-[1.02] active:scale-95 transition-all duration-200 cursor-pointer"
              >
          ...
          <div className="lg:col-span-5">
            <div className="bg-slate-50 text-slate-800 rounded-3xl p-6 sm:p-7 shadow-sm border border-slate-200 space-y-4">
              <div className="flex items-center justify-between border-b border-slate-200 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-sm font-extrabold text-[#0F172A]">Direct Pharmacist Desk</h3>
                    <p className="text-[11px] text-[#64748B]">Waqas Pharmacy Licensed Staff</p>
                  </div>
                </div>
              ...
              <div className="space-y-2.5 text-xs text-[#334155]">
                ...
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                  <span>Free consultation on affordable generic alternatives if needed</span>
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-slate-200 flex items-center justify-between">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs font-bold text-[#B91C1C] hover:text-red-800 flex items-center gap-1"
                >
